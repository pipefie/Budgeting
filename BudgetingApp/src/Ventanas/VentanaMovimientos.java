		...
		btnGenerarRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (comboCuenta.getSelectedIndex() == -1 || comboBoxCategoria.getSelectedIndex() == -1 || String.valueOf(spinnerCantidad.getValue()).equals("0") 
					...
					conn.subirMovimiento(comboBoxCategoria.getSelectedIndex()+1, Integer.parseInt(cuenta.getIdcuenta()), Double.valueOf(String.valueOf(spinnerCantidad.getValue())), dateChooser.getDate(), descripcion.getText());
